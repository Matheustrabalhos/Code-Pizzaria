...
const Menultems = ({ id , name , description , price , image , addToCart }: MenultemsProps) => {
    return(
        <div className="flex items-center space-x-4 p-4 boder-b
         hover:bg-zinc-200 duration-75 transition-colors">
           <img src={image} alt={name} className="w-28 h-28 rounded-md hover:scale-110  -rotate-2 duration-300"/>
