const Header = () => {
    return(
       <header className="fixed z-40 top-0 left-0 right-0 p-4 text-center shadow-2x1"
       style={{
        ...
        <div className="flex justify-around item-center text-center fixed z-40 left-0 right-0">
            <div>
                ...
                <div className="border-t py-1 pb-2">
                    <h2 className="text-zinc-100">Horários de funcionamentos</h2>
